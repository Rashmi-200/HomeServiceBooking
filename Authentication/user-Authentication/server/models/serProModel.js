...
const serviceProviderSchema = new mongoose.Schema({
    ...
    certificationPending: { type: Boolean, default: true },  // Default to true, meaning pending
    isCertificationVerified: { type: Boolean, default: false },  // Certification verification status
